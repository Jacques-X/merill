export type BiasCategory = "state_owned"|"party_owned_pl"|"party_owned_pn"|"church_owned"|"commercial_independent"|"investigative_independent";
...
export interface BiasCoverage { state_owned: number; party_owned_pl: number; party_owned_pn: number; church_owned: number; commercial_independent: number; investigative_independent: number; total_articles: number; }
export interface AppSettings { theme: "system"|"light"|"dark"; language: "en"|"mt"; savedClusterIds: string[]; localDisabledPublisherIds: string[]; globalDisabledPublisherIds: string[]; }
