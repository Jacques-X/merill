...
export interface AppSettings { theme: "system"|"light"|"dark"; language: "en"|"mt"; feedScope: "local"|"global"; savedClusterIds: string[]; localDisabledPublisherIds: string[]; globalDisabledPublisherIds: string[]; publisherBiasOverrides: Record<string, BiasCategory>; }
